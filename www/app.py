...
def main(*argv):
    ...
    # run_until_complete(future) : run until 'Future' is done.  @future is a placeholder, whose value evaluated later@
...
async def init(loop):
    """
    src = create_server() creates a TCP server(socket type SOCK_STREAM) bound to host and port.
    :param loop:
    :return: srv
    """
    ...
    add_static(app)
    """
    return a server object, whose "sockets" sockets contains created socket.
    """
